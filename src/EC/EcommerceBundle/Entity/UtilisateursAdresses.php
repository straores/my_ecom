 ...
 * @ORM\Entity(repositoryClass="EC\EcommerceBundle\Repository\UtilisateursAdressesRepository")
 */
class UtilisateursAdresses
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="EC\UtilisateursBundle\Entity\Utilisateur", inversedBy="adresses")
     ...
     * Set utilisateurs
     *
     * @param \EC\UtilisateursBundle\Entity\Utilisateur $utilisateurs
     * @return UtilisateursAdresses
     */
    public function setUtilisateurs(\EC\UtilisateursBundle\Entity\Utilisateur $utilisateurs = null)
    {
