...
use EC\EcommerceBundle\Entity\Produits;
...
class LoadProduits extends AbstractFixture implements OrderedFixtureInterface
{
	public function load(ObjectManager $manager)
	{
        ...
        $produit1->setCategorie($this->getReference('category1'));
        ...
        $produit2->setCategorie($this->getReference('category1'));
        ...
        $produit3->setCategorie($this->getReference('category1'));
        ...
        $produit4->setCategorie($this->getReference('category1'));
        ...
        $produit5->setCategorie($this->getReference('category2'));
        ...
        $produit6->setCategorie($this->getReference('category2'));
